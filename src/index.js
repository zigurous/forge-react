...
export { useDocumentTitle, useLoading, useMediaQuery, useMobile, useModal, useMounted, usePagination, useParallax, useSearch, useThemedFavicon } from './hooks'; // prettier-ignore
